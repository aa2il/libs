...
# SDR Play Play Pen - J.B.Attili - 2018
...
# Function to print elements of a list returned by soapdy interface
...
def sdrPlayPen(P):
    ...
    #print "Sensor info=",sdr.getSensorInfo()
    
    #settings = sdr.getSettingInfo()    # (SOAPY_SDR_RX, 0)
    #print "Available settings="
    #for s in settings: print(s)
