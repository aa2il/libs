...
JBA - This library was deleted in python 3.13 - This is the code from
3.12 - Using it for now until I get around to finding a replacement - seems ok!
...
#warnings._deprecated(__name__, remove=(3, 13))   // JBA 
