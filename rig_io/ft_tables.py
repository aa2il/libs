...
NA_COUNTRIES=['AK','PR','ZF','VI','HI','XE','V3','TI','8P','DX','KP4','HR']
...
# Need this here as both sat7.py and pyKeyer.py reference it.
# Need the 'None' entry for list box in pyKyere
SATELLITE_LIST = ['None','ISS','AO-91','AO-92','PO-101','SO-50','AO-27',\
                  'CAS-4A','CAS-4B','CAS-6', \
                  'XW-2A','XW-2B','XW-2F','RS-44','FO-99',\
                  'EO-88','AO-07','AO-73']
